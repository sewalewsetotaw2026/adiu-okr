      ...
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="w-full">
            ...
            <div className="flex items-center justify-center bg-primary-light border border-primary/20 rounded-xl px-4 py-3 h-[50px] shadow-sm">
      ...
      <div>
        ...
        <div className="space-y-4">
          ...
          <button
            ...
            className="flex items-center gap-2 text-primary font-medium hover:bg-primary-light px-4 py-2 rounded-lg transition-colors border border-dashed border-primary/40"
          >
