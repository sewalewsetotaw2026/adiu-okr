  ...
  reducers: {
    ...
    updateEmployeeRequest(
      ...
      _action: PayloadAction<
        { id: string; section?: string } & Partial<Employee>
      >,
    ) {
      state.loading = true;
      state.error = null;
    ...
    updateEmployeeSuccess(
      state,
      action: PayloadAction<Partial<Employee> | undefined>,
    ) {
      state.loading = false;
    ...
    // Resignation Letter actions
    generateResignationLetterRequest(state, _action: PayloadAction<string>) {
      state.loading = true;
      state.error = null;
    },
    generateResignationLetterSuccess(state) {
      state.loading = false;
    },
    generateResignationLetterFailure(state, action: PayloadAction<string>) {
      state.loading = false;
      state.error = action.payload;
    },
  },
