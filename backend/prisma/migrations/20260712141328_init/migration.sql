...
-- CreateEnum
CREATE TYPE "OkrEntityType" AS ENUM ('CYCLE', 'COMPANY_OBJECTIVE', 'COMPANY_KR', 'CHANGE_REQUEST', 'KR_CONTRIBUTOR', 'EMPLOYEE_OBJECTIVE', 'EMPLOYEE_KR', 'EMPLOYEE_MONTH_PLAN', 'EMPLOYEE_MONTH_PLAN_ITEM', 'WEEKLY_PLAN', 'SUBTASK', 'DAILY_PLAN', 'PROGRESS_UPDATE', 'ARCHIVE', 'EXPORT', 'SUBMISSION', 'REALIGNMENT_FLAG');
...
-- CreateEnum
CREATE TYPE "RealignmentStatus" AS ENUM ('PENDING', 'ACKNOWLEDGED', 'REALIGNED', 'DISMISSED');
...
CREATE TABLE "okr_metric_definition" (
    ...
    "value_based_progress" BOOLEAN NOT NULL DEFAULT false,
    "is_active" BOOLEAN NOT NULL DEFAULT true,
    "created_at" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updated_at" TIMESTAMP(3) NOT NULL,
...
CREATE TABLE "okr_monthly_plans" (
    ...
    "submission_id" INTEGER,
    "aligned_manager_plan_id" INTEGER,
...
-- CreateTable
CREATE TABLE "okr_change_request" (
    "id" SERIAL NOT NULL,
    "company_id" INTEGER NOT NULL,
    "cycle_id" INTEGER NOT NULL,
    "entity_type" "OkrEntityType" NOT NULL,
    ...
    "parent_change_request_id" INTEGER,
    "cascade_depth" INTEGER NOT NULL DEFAULT 0,
    "created_at" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updated_at" TIMESTAMP(3) NOT NULL,

    CONSTRAINT "okr_change_request_pkey" PRIMARY KEY ("id")
);

-- CreateTable
CREATE TABLE "okr_realignment_flag" (
    "id" SERIAL NOT NULL,
    "company_id" INTEGER NOT NULL,
    "change_request_id" INTEGER NOT NULL,
    "affected_entity_type" "OkrEntityType" NOT NULL,
    "affected_entity_id" INTEGER NOT NULL,
    "affected_owner_id" VARCHAR(20) NOT NULL,
    "status" "RealignmentStatus" NOT NULL DEFAULT 'PENDING',
    "acknowledged_at" TIMESTAMP(3),
    "realigned_at" TIMESTAMP(3),
    "dismissed_at" TIMESTAMP(3),
    "dismiss_reason" VARCHAR(500),
    "created_at" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,

    CONSTRAINT "okr_realignment_flag_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE INDEX "okr_metric_definition_company_id_value_based_progress_idx" ON "okr_metric_definition"("company_id", "value_based_progress");
...
-- CreateIndex
CREATE INDEX "okr_change_request_company_id_idx" ON "okr_change_request"("company_id");

-- CreateIndex
CREATE INDEX "okr_change_request_entity_type_entity_id_idx" ON "okr_change_request"("entity_type", "entity_id");

-- CreateIndex
CREATE INDEX "okr_change_request_requester_id_idx" ON "okr_change_request"("requester_id");

-- CreateIndex
CREATE INDEX "okr_change_request_reviewer_id_idx" ON "okr_change_request"("reviewer_id");

-- CreateIndex
CREATE INDEX "okr_change_request_status_idx" ON "okr_change_request"("status");

-- CreateIndex
CREATE INDEX "okr_change_request_parent_change_request_id_idx" ON "okr_change_request"("parent_change_request_id");

-- CreateIndex
CREATE INDEX "okr_realignment_flag_company_id_idx" ON "okr_realignment_flag"("company_id");

-- CreateIndex
CREATE INDEX "okr_realignment_flag_change_request_id_idx" ON "okr_realignment_flag"("change_request_id");

-- CreateIndex
CREATE INDEX "okr_realignment_flag_affected_owner_id_idx" ON "okr_realignment_flag"("affected_owner_id");

-- CreateIndex
CREATE INDEX "okr_realignment_flag_affected_entity_type_affected_entity_i_idx" ON "okr_realignment_flag"("affected_entity_type", "affected_entity_id");

-- CreateIndex
CREATE INDEX "okr_realignment_flag_status_idx" ON "okr_realignment_flag"("status");
...
-- AddForeignKey
ALTER TABLE "kr_contributor" ADD CONSTRAINT "kr_contributor_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "app_user"("employee_id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "employee_objective" ADD CONSTRAINT "employee_objective_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "app_user"("employee_id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "okr_monthly_plans" ADD CONSTRAINT "okr_monthly_plans_metric_definition_id_fkey" FOREIGN KEY ("metric_definition_id") REFERENCES "okr_metric_definition"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "okr_monthly_plans" ADD CONSTRAINT "okr_monthly_plans_aligned_manager_plan_id_fkey" FOREIGN KEY ("aligned_manager_plan_id") REFERENCES "okr_monthly_plans"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "okr_weekly_plans" ADD CONSTRAINT "okr_weekly_plans_aligned_manager_plan_id_fkey" FOREIGN KEY ("aligned_manager_plan_id") REFERENCES "okr_weekly_plans"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "okr_comment" ADD CONSTRAINT "okr_comment_companyKeyResultId_fkey" FOREIGN KEY ("companyKeyResultId") REFERENCES "company_key_result"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "okr_comment" ADD CONSTRAINT "okr_comment_companyObjectiveId_fkey" FOREIGN KEY ("companyObjectiveId") REFERENCES "company_objective"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "okr_comment" ADD CONSTRAINT "okr_comment_employeeKeyResultId_fkey" FOREIGN KEY ("employeeKeyResultId") REFERENCES "employee_key_result"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "okr_comment" ADD CONSTRAINT "okr_comment_employeeObjectiveId_fkey" FOREIGN KEY ("employeeObjectiveId") REFERENCES "employee_objective"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "okr_comment" ADD CONSTRAINT "okr_comment_employeeMonthPlanId_fkey" FOREIGN KEY ("employeeMonthPlanId") REFERENCES "okr_monthly_plans"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "okr_comment" ADD CONSTRAINT "okr_comment_weeklyPlanId_fkey" FOREIGN KEY ("weeklyPlanId") REFERENCES "okr_weekly_plans"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "okr_change_request" ADD CONSTRAINT "okr_change_request_requester_id_fkey" FOREIGN KEY ("requester_id") REFERENCES "app_user"("employee_id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "okr_change_request" ADD CONSTRAINT "okr_change_request_reviewer_id_fkey" FOREIGN KEY ("reviewer_id") REFERENCES "app_user"("employee_id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "okr_change_request" ADD CONSTRAINT "okr_change_request_parent_change_request_id_fkey" FOREIGN KEY ("parent_change_request_id") REFERENCES "okr_change_request"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "okr_realignment_flag" ADD CONSTRAINT "okr_realignment_flag_change_request_id_fkey" FOREIGN KEY ("change_request_id") REFERENCES "okr_change_request"("id") ON DELETE CASCADE ON UPDATE CASCADE;
