...
export enum NotificationType {
  ...
  OKR_FEEDBACK = "OKR_FEEDBACK",
  OKR_PUBLISHED = "OKR_PUBLISHED",
  // Post-Publish Edit Flow
  OKR_CHANGE_REQUEST_SUBMITTED = "OKR_CHANGE_REQUEST_SUBMITTED",
  OKR_CHANGE_REQUEST_APPROVED = "OKR_CHANGE_REQUEST_APPROVED",
  OKR_CHANGE_REQUEST_REJECTED = "OKR_CHANGE_REQUEST_REJECTED",
  OKR_REALIGNMENT_REQUIRED = "OKR_REALIGNMENT_REQUIRED",
}
